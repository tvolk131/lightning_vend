...
export class DeviceSessionManager {
  private deviceSetupCodeManager: DeviceSetupCodeManager = new DeviceSetupCodeManager();
   ...
   * @param deviceSetupCode The device setup code that was generated by `createDeviceSetupCode`.
   * @param userName The user that is claiming the device.
   * @param deviceDisplayName The displayed name that the user wants to give the device.
   * @returns The claimed device, or `undefined` if the device setup code is invalid.
   */
  public claimDevice(
    ...
    const deviceSessionId = this.deviceSetupCodeManager.getIdFromCode(deviceSetupCode);
  ...
  public getDeviceNameFromSessionId(deviceSessionId: string): DeviceName | undefined {
